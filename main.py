  ...
  async def image_to_video(
      ...
      try:
          image_downloaded = await download_file(request.image_url, image_path)
          ...
          success = create_video_from_image(image_path, audio_path, output_path)
